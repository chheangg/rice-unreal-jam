...
def main():
    # cv2.VideoCapture(0) is intentionally NOT at module import time - it used
    # to be, which meant merely `import detect` opened a real camera as a
    # side effect. Guarding it behind main()/__name__ check makes this file
    # safe to import (e.g. for a future test) without touching hardware.
